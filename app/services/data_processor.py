...
class DataProcessor:
            ...
            if settings.REDUCER_PATH.exists():
                ...
                if self.dimension_reducer:
                    ...
                    if self.dimension_reducer.selected_features:
                        logger.info(f"  Selected features: {len(self.dimension_reducer.selected_features)}")
            else:
    ...
    def align_features(self, processed_data: pd.DataFrame, 
                      model_features: list) -> Optional[pd.DataFrame]:
        """
                ...
                if original_features:
                    ...
                    for feature in original_features:
                        if feature not in processed_data.columns:
                            ...
                            logger.debug(f"Added missing original feature '{feature}' with default value 0")
