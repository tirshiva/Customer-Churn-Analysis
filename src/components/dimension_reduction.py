...
class DimensionReducer:
    ...
    def __init__(
        self,
        method: Literal["pca", "selectkbest", "mutual_info", "select_from_model", "rfe", "none"] = "select_from_model",
    ...
    def _apply_pca(self, X: pd.DataFrame, y: Optional[pd.Series]) -> Optional[pd.DataFrame]:
        ...
        try:
            ...
            if self.n_components is None:
                ...
                logger.info(f"PCA: {n_components} components explain {self.variance_threshold*100}% variance")
            else:
