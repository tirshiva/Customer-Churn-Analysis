...
class AdvancedMLPipeline:
    ...
    def __init__(
        ...
        self.evaluation_output_path = evaluation_output_path or self.model_output_path.parent / "evaluation_report.json"
        self.model_comparison_path = self.model_output_path.parent / "model_comparison.json"
    ...
    def save_model(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Best model ({best_model_name}) saved to {self.model_output_path}")
